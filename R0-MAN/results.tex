...
\begin{figure}
%\left
\subfloat[]{\includegraphics[width=0.168\textwidth, trim= 3mm 12.5mm 0mm 16.5mm, clip]{pictures/traj1.eps}\label{fig:traj1}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.168\textwidth, trim= 3mm 12.5mm 0mm 16.5mm, clip]{pictures/traj2.eps}\label{fig:traj2}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.168\textwidth, trim= 3mm 12.5mm 0mm 16.5mm, clip]{pictures/traj3.eps}\label{fig:traj3}}%
%\hspace{0.1cm}
...
\begin{figure*}
\centering
\subfloat[]{\includegraphics[width=0.169\textwidth, trim= 1mm 13mm 2mm 8mm, clip]{pictures/m1.eps}\label{fig:1_1}}%
%\hspace{%0.1cm}
\subfloat[]{\includegraphics[width=0.1690\textwidth, trim= 1mm 13mm 2mm 8mm, clip]{pictures/m2.eps}\label{fig:1_2}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.1690\textwidth, trim= 1mm 13mm 2mm 8mm, clip]{pictures/m3.eps}\label{fig:1_3}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.1690\textwidth, trim= 1mm 13mm 2mm 8mm, clip]{pictures/m4.eps}\label{fig:1_4}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.169\textwidth, trim= 1mm 13mm 2mm 8mm, clip]{pictures/m5.eps}\label{fig:1_5}}%
...
\begin{figure}
\centering
\subfloat[]{\includegraphics[width=0.162\textwidth, trim= 1mm 13mm 2mm 9mm, clip ]{pictures/two_m1.eps}\label{fig:3_1}}% \vspace{<whatever>}
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.162\textwidth, trim= 1mm 13mm 2mm 9mm, clip ]{pictures/two_m2.eps}\label{fig:3_2}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.162\textwidth, trim= 1mm 13mm 2mm 9mm, clip ]{pictures/two_m3.eps}\label{fig:3_3}}%

%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.162\textwidth, trim= 1mm 13mm 2mm 9mm, clip ]{pictures/two_m4.eps}\label{fig:3_4}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.162\textwidth, trim= 1mm 13mm 2mm 9mm, clip ]{pictures/two_m5.eps}\label{fig:3_5}}%
%\hspace{0.1cm}
