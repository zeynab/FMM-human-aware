...
\author{Zeynab Talebpour$^{1}$ \and Deepak Viswanathan$^{2}$ \and Rodrigo Ventura$^{3}$ \and Gwenn Englebienne$^{4}$ \and Alcherio Martinoli$^{5}$% <-this % stops a space
\thanks{$^{1,5}$Distributed Intelligent Systems and Algorithms Laboratory,
School of Architecture, Civil and Environmental Engineering,
 \'Ecole Polytechnique F\'ed\'erale de Lausanne 
        {\tt\small \{zeynab.talebpour, alcherio.martinoli\}@epfl.ch}}% <-this % stops a space
\thanks{$^{2}$Deepak Viswanathan, Department of Informatics, University of Amsterdam, Netherlands
...
\thanks{$^{4}$Gwenn Englebienne, Human Media Interaction, University of Twente, Netherlands
...
\input{intro}
\input{background}
\input{perception_model}
\input{social_navigation_model}
\input{experimental_setup}
\input{results}
\input{conclusions}
%\input{probabilistic_data_fusion}
