...
Here, we use a deterministic output from the tracker, without considering the particles, by just using the mode of the distribution as the deterministic location of the people, along with the conventional costmap model. 
