...
\begin{figure*}[t!]
%\centering
\subfloat[]{\includegraphics[width=0.2\textwidth]{pictures/m1.eps}\label{fig:1_1}}%
%\hspace{%0.1cm}
\subfloat[]{\includegraphics[width=0.2\textwidth]{pictures/m2.eps}\label{fig:1_2}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.2\textwidth]{pictures/m3.eps}\label{fig:1_3}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.2\textwidth]{pictures/m4.eps}\label{fig:1_4}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.2\textwidth]{pictures/m5.eps}\label{fig:1_5}}%
