...
\begin{figure}
\centering
{\includegraphics[width=0.4\textwidth]{pictures/all.eps}\label{fig:costmapPic}}%
...
\begin{figure}[t!]
\centering
\subfloat[]{\includegraphics[width=0.162\textwidth, trim= 2mm 13mm 2mm 9mm, clip ]{pictures/two_m1.eps}\label{fig:3_1}}% \vspace{<whatever>}
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.162\textwidth, trim= 2mm 13mm 2mm 9mm, clip ]{pictures/two_m2.eps}\label{fig:3_2}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.162\textwidth, trim= 2mm 13mm 2mm 9mm, clip ]{pictures/two_m3.eps}\label{fig:3_3}}%

%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.162\textwidth, trim= 2mm 13mm 2mm 9mm, clip ]{pictures/two_m4.eps}\label{fig:3_4}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.162\textwidth, trim= 2mm 13mm 2mm 9mm, clip ]{pictures/two_m5.eps}\label{fig:3_5}}%
%\hspace{0.1cm}
