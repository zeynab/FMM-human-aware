...
For each of the scenarios described in section \ref{sec:scenarios}, we have compared the results obtained from the 1) basic navigation (BN), 2) deterministic (DHA) 3) K-means clustering (KHA), 4) mean shift clustering (SHA), and 5) social cost convolution (CHA) human-aware (HA) navigation. We will only report the trajectories and metrics obtained from the results of our real experiments for the sake of conciseness. Larger values for $m_{1}$ and $m_{6}$, and smaller values for $m_{2}$-$m_{5}$ are preferable.
...
\begin{figure}
%\left
\subfloat[]{\includegraphics[width=0.17\textwidth, trim= 3mm 13mm 0mm 8mm, clip]{pictures/traj1.eps}\label{fig:traj1}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.17\textwidth, trim= 3mm 13mm 0mm 8mm, clip]{pictures/traj2.eps}\label{fig:traj2}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.17\textwidth, trim= 3mm 13mm 0mm 8mm, clip]{pictures/traj3.eps}\label{fig:traj3}}%
%\hspace{0.1cm}
...
\begin{figure}[t!]
\centering
\subfloat[]{\includegraphics[width=0.163\textwidth, trim= 2mm 13mm 2mm 8mm, clip ]{pictures/two_m1.eps}\label{fig:3_1}}% \vspace{<whatever>}
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.163\textwidth, trim= 2mm 13mm 2mm 8mm, clip ]{pictures/two_m2.eps}\label{fig:3_2}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.163\textwidth, trim= 2mm 13mm 2mm 8mm, clip ]{pictures/two_m3.eps}\label{fig:3_3}}%

%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.163\textwidth, trim= 2mm 13mm 2mm 8mm, clip ]{pictures/two_m4.eps}\label{fig:3_4}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.163\textwidth, trim= 2mm 13mm 2mm 8mm, clip ]{pictures/two_m5.eps}\label{fig:3_5}}%
%\hspace{0.1cm}
