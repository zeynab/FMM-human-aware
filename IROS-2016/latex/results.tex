...
\begin{figure}[t!]
\centering
\subfloat[]{\includegraphics[width=0.14\textwidth]{pictures/traj1.eps}\label{fig:traj1}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.14\textwidth]{pictures/traj2.eps}\label{fig:traj2}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.14\textwidth]{pictures/traj3.eps}\label{fig:traj3}}%
%\hspace{0.1cm}
...
\begin{figure*}[t!]
\centering
\subfloat[]{\includegraphics[width=0.18\textwidth]{pictures/m1.eps}\label{fig:1_1}}%
%\hspace{%0.1cm}
\subfloat[]{\includegraphics[width=0.18\textwidth]{pictures/m2.eps}\label{fig:1_2}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.18\textwidth]{pictures/m3.eps}\label{fig:1_3}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.18\textwidth]{pictures/m4.eps}\label{fig:1_4}}%
%\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.18\textwidth]{pictures/m5.eps}\label{fig:1_5}}%
...
\begin{figure}[!]
\centering
\subfloat[]{\includegraphics[width=0.160\textwidth]{pictures/dy_m4.eps}\label{fig:2_2}}%
\hspace{0.1cm}
\subfloat[]{\includegraphics[width=0.16\textwidth]{pictures/dy_m5.eps}\label{fig:2_3}}%
